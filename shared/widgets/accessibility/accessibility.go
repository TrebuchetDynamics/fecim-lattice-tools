...
// IsFocused reports whether the focus indicator currently shows focused state.
func (fi *FocusIndicator) IsFocused() bool {
	return fi.focused
}
...
// ResetStateForTest clears package-level accessibility state for tests.
