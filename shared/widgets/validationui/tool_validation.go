...
func NewToolValidationWidgets(opts ToolValidationOptions) *ToolValidationWidgets {
	...
	update := func() {
		crosssimInfo := validation.CrossSimInfo()
		badcrossbarInfo := validation.BadCrossbarInfo()
		interaction.SafeUpdateLabel(crosssimStatus, statusText(crosssimInfo.Status, "CrossSim"))
		interaction.SafeUpdateLabel(badcrossbarStatus, statusText(badcrossbarInfo.Status, "BadCrossbar"))
	}
	...
	toolsBtn := widget.NewButton(opts.ButtonLabel, func() {
		go func() {
			interaction.SafeUpdateLabel(crosssimStatus, busyText("CrossSim"))
			interaction.SafeUpdateLabel(badcrossbarStatus, busyText("BadCrossbar"))
			...
			interaction.SafeUpdateLabel(crosssimStatus, statusText(validation.CrossSimInfo().Status, "CrossSim"))
			interaction.SafeUpdateLabel(badcrossbarStatus, statusText(validation.BadCrossbarInfo().Status, "BadCrossbar"))
