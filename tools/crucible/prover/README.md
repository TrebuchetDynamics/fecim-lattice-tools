...
Reports should be saved under `tools/crucible/prover/reports/` during review and promoted to `validation/moduleN/` when they become executable validation artifacts.
