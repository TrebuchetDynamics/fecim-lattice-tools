...
class CLITest(unittest.TestCase):
    def test_help_lists_core_commands(self):
        ...
        self.assertIn("promote-pdf", text)
    ...
    def test_search_help_lists_local_option(self):
        ...
        self.assertIn("--semantic", out.getvalue())
    ...
    def test_core_commands_import_without_optional_dependencies(self):
        ...
        import fecim_research.promotion
        ...
        self.assertTrue(hasattr(fecim_research.promotion, "run_promote_pdf"))
