...
### Changed
- **Module 6: Architecture Refactoring** - Evolved from "weight compiler" to "universal chip design tool"
  - Added three operation modes: Storage (NAND), Memory (DRAM), Compute (AI)
  - Weights are now optional - only used in Compute mode for pre-programming
  ...
  - Backward-compatible: legacy `Compile()` API still works for existing code

## [0.9.0] - 2026-01-23

### Added
- **Module 6: FeCIM Design Suite** with 7-tab interface
  - Tab 1: Compiler (design generation for Storage/Memory/Compute modes)
...
- **OpenLane integration documentation**
  - `module6-eda/docs/INTEGRATION.md` - Complete integration guide
  - `docs/OPENLANE_STUDY.md` - Validated findings from OpenLane source
  - `docs/module6-openlane-integration.md` - Quick-start guide
  - `docs/module6-technical-plan.md` - Implementation roadmap
- **Working examples**
  - `examples/01-basic-8x8/` - Basic crossbar compilation
  - `examples/02-mnist-layer/` - Neural network layer
