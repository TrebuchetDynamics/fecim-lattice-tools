...
var demos = []Demo{
	{
		...
		Ready:       true,
		BinaryPath:  "module1-hysteresis/hysteresis",
		BuildCmd:    "module1-hysteresis/cmd/hysteresis",
	},
	{
		Number:      2,
		Title:       "Crossbar MVM",
		...
		Ready:       true,
		BinaryPath:  "module2-crossbar/crossbar-gui",
		BuildCmd:    "module2-crossbar/cmd/crossbar-gui",
	},
	{
		Number:      3,
		Title:       "MNIST 87%",
		...
		Ready:       true,
		BinaryPath:  "module3-mnist/mnist-gui",
		BuildCmd:    "module3-mnist/cmd/mnist-gui",
	},
	{
		Number:      4,
		Title:       "Circuits",
		...
		Ready:       true,
		BinaryPath:  "module4-circuits/circuits-gui",
		BuildCmd:    "module4-circuits/cmd/circuits-gui",
	},
	{
		Number:      5,
		Title:       "Thermal",
	...
	},
	{
		...
		Ready:       true,
		BinaryPath:  "demo6-multilayer/multilayer-gui",
		BuildCmd:    "demo6-multilayer/cmd/multilayer-gui",
	},
	{
		Number:      7,
		Title:       "Non-Idealities",
		Description: "IR drop, sneak paths\nConductance drift",
		Ready:       true,
		BinaryPath:  "demo7-nonidealities/nonidealities-gui",
		BuildCmd:    "demo7-nonidealities/cmd/nonidealities-gui",
	},
	{
		Number:      8,
		Title:       "Why FeCIM?",
		...
		Ready:       true,
		BinaryPath:  "module5-comparison/comparison-gui",
		BuildCmd:    "module5-comparison/cmd/comparison-gui",
	},
}
