	...
	return []DemoInfo{
		{
			...
			Description: "Discover how ferroelectric materials remember: watch polarization flip between discrete states (30-level conference claim; 32-140 peer-reviewed) to store multi-bit data",
			Icon:        "~",
			Ready:       true,
		},
		{
...
func NewResponsiveFooter() *ResponsiveFooter {
	f := &ResponsiveFooter{
		metricsText: canvas.NewText("30 States (conference claim) | 96-98% MNIST | 25-100× vs NAND | 10⁹ Cycles | TRL 4", color.RGBA{0, 212, 255, 230}),
