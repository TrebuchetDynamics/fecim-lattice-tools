...
Validation in this project is separate from ordinary unit testing. Unit tests show that code paths run. Validation asks whether a model respects published data, physical conservation laws, or an independent tool under a documented scope.
