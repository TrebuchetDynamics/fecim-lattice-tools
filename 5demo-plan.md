...
cp demo7-nonidealities/pkg/irdrop/*.go demo2-crossbar/pkg/crossbar/
cp demo7-nonidealities/pkg/sneak/*.go demo2-crossbar/pkg/crossbar/
cp demo7-nonidealities/pkg/drift/*.go demo2-crossbar/pkg/crossbar/
...
# New: "multilayer-ferroelectric-cim-visualizer/demo2-crossbar/pkg/crossbar"
```

**Day 3: Create tabbed GUI**

```go
// demo2-crossbar/pkg/gui/tabs/ideal_tab.go
...
```go
// demo2-crossbar/pkg/gui/tabs/irdrop_tab.go
...
- [ ] Tests pass: `go test ./demo2-crossbar/...`
...
**New location:** demo2-crossbar/pkg/gui/tabs/
...
./demo1-hysteresis/hysteresis
./demo2-crossbar/crossbar-gui
./demo3-mnist/mnist-gui
./demo4-circuits/circuits-gui
...
├── demo1-hysteresis/          ✅ Keep as-is
├── demo2-crossbar/            ✅ Enhanced with tabs
├── demo3-mnist/               🚀 Full enhancement (Phase 2)
├── demo4-circuits/            ✅ Minor enhancements
├── demo5-comparison/          🔲 Build in Phase 3
├── shared/                    Shared utilities
├── docs/
│   ├── README.md
│   ├── demo1-hysteresis.md
│   ├── demo2-crossbar.md      ← Updated with tab docs
│   ├── demo3-mnist.md         ← Full enhancement plan
│   ├── demo4-circuits.md
...
case $choice in
    1)
        ...
        cd demo1-hysteresis && ./hysteresis
        ;;
    2)
    ...
    4)
        ...
        cd demo4-circuits && ./circuits-gui
        ;;
    5)
...
- [ ] Tests pass: `go test ./demo3-mnist/... -cover`
...
Apply to:
- `demo1-hysteresis/README.md`
- `demo2-crossbar/README.md` (update with tab info)
- `demo3-mnist/README.md` (full enhancement docs)
- `demo4-circuits/README.md`
...
```
multilayer-ferroelectric-cim-visualizer/
├── demo1-hysteresis/          # Standalone demo
├── demo2-crossbar/            # Shared crossbar package
├── demo3-mnist/               # Imports demo2/crossbar
├── demo4-circuits/            # Standalone demo
...
```bash
go test ./demo1-hysteresis/... -v
go test ./demo2-crossbar/... -v
go test ./demo3-mnist/... -v
go test ./demo4-circuits/... -v
...
# Save to:
docs/screenshots/
├── demo1-hysteresis.gif
├── demo1-hysteresis-static.png
├── demo2-crossbar-tabs.gif
├── demo2-crossbar-irdrop.png
├── demo3-mnist-drawing.gif
├── demo3-mnist-4zones.png
├── demo3-mnist-failure.png
├── demo4-circuits.gif
├── demo4-circuits-timing.png
...
```go
// demo3-mnist/pkg/core/quantize_bench_test.go
...
2. Update imports if targeting Demo 7:
   ...
   - New: `demo2-crossbar/pkg/crossbar`
...
| Test coverage (demo3) | >80% | `go test -cover ./demo3-mnist/pkg/core` |
