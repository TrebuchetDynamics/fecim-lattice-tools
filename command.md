/ralph-loop:ralph-loop "You are the Lead Engineer for IronLattice. Your goal is to advance Demos 1, 2, and 3 from 'Planned' to 'Functional'.
...
- If you finish all tasks or cannot proceed further, output exactly: <promise>COMPLETE</promise>." --max-iterations 512 --completion-promise "COMPLETE"