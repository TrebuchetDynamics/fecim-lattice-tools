...
```go
// module6-eda/pkg/layout/generator.go
...
```go
// module6-eda/pkg/explorer/explorer.go
...
```go
// module6-eda/pkg/simulate/spice.go
...
```go
// module6-eda/pkg/export/export.go
...
import (
    ...
    "module6-eda/pkg/compiler"
    "module6-eda/pkg/explorer"
    "module6-eda/pkg/layout"
    "module6-eda/pkg/simulate"
)
...
─────────────────────────────
□ mkdir module6-eda && cd module6-eda
□ go mod init module6-eda
□ go get fyne.io/fyne/v2@latest
...
mkdir -p module6-eda/{cmd/eda-gui,pkg/{compiler,export,gui/tabs},data}
cd module6-eda
