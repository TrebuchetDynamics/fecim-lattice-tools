...
Screens:
      ...
      - ContentContainer (Stack):
          ...
          components:
            - BuilderContent (Canvas):
                ...
                file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:27
            ...
            - LearnContent (Canvas):
                ...
                file: module6-eda/pkg/gui/tabs/learn_tab.go:26
                visibility: Controlled by viewSelector.OnChanged
                state: Shown when viewSelector == "2. Learn"

  - name: EmbeddedApp
    file: module6-eda/pkg/gui/embedded.go:24
    description: Embedded version for unified visualizer (AppTabs instead of Stack)
    layout:
      - AppTabs (Container):
          file: module6-eda/pkg/gui/embedded.go:37-40
          components:
            - Tab 1 Builder:
  ...
  - name: BuilderValidationTab
    ...
    layout:
      - TopSection (VBox):
          file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:718-723
          components:
            - ConfigSplit (HSplit):
                file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:626-627
                offset: 0.5
                left: CellPanel
                right: ArrayPanel
                components:
                  - CellPanel (VBox):
                      file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:590-594
                      components:
                        - CellTitle (Label):
                            type: widget.Label
                            text: "Cell Config"
                            style: Bold
                            file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:591
                        - CellForm (Form):
                            type: widget.Form
                            file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:580-588
                            fields:
                              - nameEntry:
                                  purpose: Cell name
                                  default: "fecim_bitcell"
                                  file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:29-30
                              - widthEntry:
                                  purpose: Cell width (μm)
                                  default: "0.460"
                                  file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:32-33
                                  bindings: OnChanged -> updateStats()
                              - heightEntry:
                                  purpose: Cell height (μm)
                                  default: "2.720"
                                  file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:35-36
                                  bindings: OnChanged -> updateStats()
                              - riseEntry:
                                  purpose: Rise time (ns) - PLACEHOLDER
                                  default: "0.1"
                                  file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:39-40
                              - fallEntry:
                                  purpose: Fall time (ns) - PLACEHOLDER
                                  default: "0.1"
                                  file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:42-43
                              - capEntry:
                                  purpose: Input capacitance (pF) - PLACEHOLDER
                                  default: "0.002"
                                  file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:45-46
                              - leakageEntry:
                                  purpose: Leakage power (nW) - PLACEHOLDER
                                  default: "0.001"
                                  file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:48-49
                        - CellAreaLabel (Label):
                            type: widget.Label
                            purpose: Display calculated cell area
                            file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:73
                            bindings: Updated by updateStats()
                  - ArrayPanel (VBox):
                      file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:617-623
                      components:
                        - ArrayTitle (Label):
                            type: widget.Label
                            text: "Array Config"
                            style: Bold
                            file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:618
                        - ArrayForm (Form):
                            type: widget.Form
                            file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:597-602
                            fields:
                              - rowsEntry:
                                  purpose: Array rows
                                  default: "4"
                                  file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:76-77
                                  bindings: OnChanged -> updateStats(), updates cfg.Rows
                              - colsEntry:
                                  purpose: Array columns
                                  default: "4"
                                  file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:79-80
                                  bindings: OnChanged -> updateStats(), updates cfg.Cols
                              - modeSelect:
                                  purpose: Operation mode selection
                                  options: ["storage", "memory", "compute"]
                                  default: cfg.Mode
                                  file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:99-104
                              ...
                              - archSelect:
                                  ...
                                  file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:106-109
                                  bindings: OnChanged -> updates cfg.Architecture
                        - ModeHelpText (Label):
                            type: widget.Label
                            purpose: Explain selected mode
                            wrapping: TextWrapWord
                            file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:83-104
                            bindings: Updated by updateModeHelp() when mode changes
                        - StatsBox (VBox):
                            file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:606-615
                            components:
                              - StatsTitle (Label):
                                  text: "Statistics"
                                  style: Bold
                                  file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:605
                              - TotalLabel:
                                  purpose: Total Cells count
                                  file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:112
                                  bindings: Updated by updateStats()
                              - AreaLabel:
                                  purpose: Array area (μm²)
                                  file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:113
                                  bindings: Updated by updateStats()
                              - WLLengthLabel:
                                  purpose: Word line length
                                  file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:114
                                  bindings: Updated by updateStats()
                              - BLLengthLabel:
                                  purpose: Bit line length
                                  file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:115
                                  bindings: Updated by updateStats()
                              - DensityLabel:
                                  purpose: Cell density (cells/μm²)
                                  file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:116
                                  bindings: Updated by updateStats()
                              - UtilizationLabel:
                                  purpose: Utilization percentage
                                  file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:117
                                  bindings: Updated by updateStats()
            - Separator (widget.Separator):
                file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:720
            - ActionButtons (HBox):
                file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:647-651
                components:
                  - GenerateAllBtn (Button):
                      type: widget.Button
                      text: "Generate All"
                      purpose: Generate LEF/LIB/V/Verilog/DEF/Config files
                      file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:271-352
                  ...
                  - ValidateAllBtn (Button):
                      ...
                      file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:355-486
                      async: true
                      bindings:
                  ...
                  - ExportPackageBtn (Button):
                      ...
                      file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:489-575
                      async: true
                      bindings:
            ...
            - StatusBar (HBox):
                file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:712-715
                components:
                  - StatusLabel (Label):
                      type: widget.Label
                      purpose: Show current operation status
                      file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:264
                      bindings: Updated by all async operations
      - PreviewTabs (AppTabs):
          file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:640-644
            ...
            - VerilogTab:
                components:
                  - VerilogStatsLabel:
                      ...
                      file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:179
                  ...
                  - VerilogPreview (MultiLineEntry):
                      ...
                      file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:168-170
                      bindings: Updated by generateAllBtn
            - DEFTab:
                components:
                  - DEFStatsLabel:
                      purpose: Show components count and filename
                      file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:180
                      bindings: Updated after DEF generation
                  - DEFPreview (MultiLineEntry):
                      type: widget.MultiLineEntry
                      purpose: Show generated DEF placement
                      wrapping: TextWrapOff
                      file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:172-174
                      bindings: Updated by generateAllBtn
            - LayoutTab:
                components:
                  - LayoutViz (Label):
                      ...
                      style: Monospace
                      file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:176-177
                      bindings: Updated by makeBuilderLayoutVisualization()
      - ValidationSection (VBox):
          file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:705-709
          description: Bottom section with validation results and log
          components:
            - ValidationSplit (HSplit):
                file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:693-697
                offset: 0.65 (65% validation, 35% OpenLane)
                components:
                  - ValidationResultsPanel (VBox):
                      file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:688-691
                      components:
                        - ValidationSummary (Label):
                            type: widget.Label
                            purpose: Overall pass/fail status
                            style: Bold
                            file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:186-187
                            bindings: Updated by validateAllBtn
                        - ValidationRow (HBox):
                            file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:654-662
                            components:
                              - YosysResult (Label):
                                  purpose: Verilog syntax validation result
                                  file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:183
                                  values: ["Not validated", "...", "✓ PASS", "✗ FAIL"]
                              - DEFResult (Label):
                                  purpose: DEF syntax validation result
                                  file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:184
                                  values: ["Not validated", "...", "✓ PASS", "✗ FAIL"]
                              - CrossResult (Label):
                                  purpose: LEF/LIB/V cross-check result
                                  file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:185
                                  values: ["Not validated", "...", "✓ PASS", "✗ FAIL"]
                              - PlacementResult (Label):
                                  purpose: OpenLane placement validation result
                                  file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:205
                                  values: ["Not validated", "...", "✓ PASS", "✗ ERROR", "⊝ SKIP"]
                  - OpenLanePanel (VBox):
                      file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:668-675
                      components:
                        - OpenLaneHelpText (Label):
                            text: "Optional: Enable placement validation if OpenLane/Docker is installed"
                            wrapping: TextWrapWord
                            file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:665-666
                        - DockerStatus (Label):
                            purpose: Show Docker image status
                            file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:203
                        ...
                        - PDKStatus (Label):
                            ...
                            file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:204
                        ...
                        - PullImageBtn (Button):
                            ...
                            file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:234-258
                            async: true
                        ...
                        - EnablePlacementCheck (Check):
                            ...
                            file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:261
                            bindings: Checked during validateAllBtn execution (line 427)
            - LogSection (VBox):
                file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:699-703
                components:
                  - LogHeader (HBox):
                      components:
                        - LogTitle (Label):
                        ...
                        - ClearLogBtn (Button):
                            ...
                            file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:198-200
                  - LogOutput (MultiLineEntry):
                      type: widget.MultiLineEntry
                      purpose: Show validation/generation logs
                      wrapping: TextWrapWord
                      style: Monospace
                      file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:188-190
  ...
  - name: LearnTab
    ...
    layout:
      - Header (VBox):
          file: module6-eda/pkg/gui/tabs/learn_tab.go:96-102
          components:
            - HeaderTitle (Label):
                text: "FeCIM Array Builder - Learning Center"
                style: Bold, Centered
                file: module6-eda/pkg/gui/tabs/learn_tab.go:97
            - HeaderSubtitle (Label):
                text: "Understanding OpenLane and where our tool fits in"
                file: module6-eda/pkg/gui/tabs/learn_tab.go:98
            - Separator:
                file: module6-eda/pkg/gui/tabs/learn_tab.go:99
      - Split (HSplit):
          file: module6-eda/pkg/gui/tabs/learn_tab.go:92-93
          offset: 0.25 (25% sidebar, 75% content)
          components:
            - Sidebar (VBox):
                file: module6-eda/pkg/gui/tabs/learn_tab.go:85-89
                components:
                  - SidebarTitle (Label):
                      text: "Topics"
                      style: Bold, Centered
                      file: module6-eda/pkg/gui/tabs/learn_tab.go:81
                  - TopicSelector (List):
                      type: widget.List
                      purpose: Select learning topic
                      file: module6-eda/pkg/gui/tabs/learn_tab.go:34-52
                      items:
                        - "1. What is FeCIM EDA?"
            ...
            - ContentScroll (Scroll):
                file: module6-eda/pkg/gui/tabs/learn_tab.go:55-56
                minSize: 750x500
                components:
                  - DynamicContent (VBox):
  ...
  - name: LearnContent_Intro
    ...
    components:
      ...
      - OpenLaneFlowDiagram (Canvas):
          ...
          file: module6-eda/pkg/gui/tabs/learn_visuals.go:41
  ...
  - name: LearnContent_Crossbar
    ...
    components:
      ...
      - 1T1RSection (VBox):
          components:
            - 1T1RTitle (Label):
                ...
                style: Bold
                file: module6-eda/pkg/gui/tabs/learn_tab.go:202
            - 1T1RDesc (Label):
                purpose: Describe 1T1R architecture pros/cons
                wrapping: TextWrapWord
                file: module6-eda/pkg/gui/tabs/learn_tab.go:203-206
            - 1T1RDiagram (Canvas):
                purpose: Isometric 3x3 1T1R crossbar visualization
                file: module6-eda/pkg/gui/tabs/learn_visuals.go:360
                size: 620x440 (enforced by sizedContainer)
      ...
      - ComparisonTable (Canvas):
          ...
          file: module6-eda/pkg/gui/tabs/learn_visuals.go:527
      ...
      - SneakPathExplanation (VBox):
          components:
            - SneakPathTitle (Label):
                ...
                style: Bold
                file: module6-eda/pkg/gui/tabs/learn_tab.go:215
            - SneakPathDesc (Label):
                purpose: Explain sneak path current issue
                wrapping: TextWrapWord
                file: module6-eda/pkg/gui/tabs/learn_tab.go:216-217
      - RecommendationCard (Card):
          purpose: Show array size recommendations
          file: module6-eda/pkg/gui/tabs/learn_tab.go:220-221
          text: "<= 16x16: Passive | 32x32: Either | >= 64x64: 1T1R"

  - name: LearnContent_Files
    file: module6-eda/pkg/gui/tabs/learn_tab.go:257
    description: Topic 3 content showing EDA file formats
    components:
      - Title (Label):
          text: "EDA Files We Generate"
          style: Bold
          file: module6-eda/pkg/gui/tabs/learn_tab.go:258
      - CardsGrid (Grid):
          purpose: Show 4 file format preview cards
          file: module6-eda/pkg/gui/tabs/learn_tab.go:266
          columns: 2
          cards:
            - LEFPreviewCard:
                file: module6-eda/pkg/gui/tabs/learn_visuals.go:790
                shows: LEF MACRO example with SIZE and PIN
                size: 360x224
            - DEFPreviewCard:
                file: module6-eda/pkg/gui/tabs/learn_visuals.go:801
                shows: DEF COMPONENTS with FIXED placement
                size: 360x224
            - VerilogPreviewCard:
                file: module6-eda/pkg/gui/tabs/learn_visuals.go:812
                shows: Verilog module with cell instantiation
                size: 360x224
            - LibertyPreviewCard:
                file: module6-eda/pkg/gui/tabs/learn_visuals.go:824
                shows: Liberty library with timing (PLACEHOLDER)
                size: 360x224
      - FilePurposes (Label):
          purpose: Explain purpose of each file format
          wrapping: TextWrapWord
          file: module6-eda/pkg/gui/tabs/learn_tab.go:270-281
      ...
      - ReferencesCard (Canvas):
          ...
          file: module6-eda/pkg/gui/tabs/learn_visuals.go:840
          size: 420x310
          categories:
            - "EDA / OpenLane"
...
DataFlow:
  - trigger: User changes rows/cols/width/height
    ...
    file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:120-159
  ...
  - trigger: Tab loads
    ...
    file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:208-231, 678-685
  ...
  - trigger: User selects Learn topic
    ...
    file: module6-eda/pkg/gui/tabs/learn_tab.go:59-75
...
ArchitectureNotes:
  - pattern: Minimal embedded wrapper
    ...
    file: module6-eda/pkg/gui/embedded.go:14-21
  ...
  - pattern: Shared config pointer
    ...
    file: module6-eda/pkg/gui/app.go:20-28, embedded.go:26-34
  ...
  - pattern: Mode help text
    ...
    file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:86-97
  ...
  - pattern: Validation workflow
    ...
    file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:267-575
  ...
  - pattern: Optional OpenLane integration
    ...
    file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:208-231, 427-461
  ...
  - pattern: Educational visuals
    ...
    file: module6-eda/pkg/gui/tabs/learn_tab.go:14-23, learn_visuals.go
  ...
  - pattern: File format cards
    ...
    file: module6-eda/pkg/gui/tabs/learn_visuals.go:757-787
  ...
  - pattern: IEEE references
    ...
    file: module6-eda/pkg/gui/tabs/learn_visuals.go:840-960
...
EducationalDisclaimers:
  ...
  - location: Config Types
    ...
    file: module6-eda/pkg/config/types.go:18-24

  - location: Cell Config
    text: |
      "PLACEHOLDER timing values"
    file: module6-eda/pkg/config/types.go:48-52

TestCoverage:
  - file: module6-eda/pkg/config/types_test.go
...
KeyFeatures:
  ...
  - name: Mode-aware Help
    ...
    file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:86-104
  ...
  - name: Docker Integration
    ...
    file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:208-231, 234-258
  ...
  - name: Educational Learn Tab
    ...
    file: module6-eda/pkg/gui/tabs/learn_tab.go
  ...
  - name: Isometric Crossbar Visualizations
    ...
    file: module6-eda/pkg/gui/tabs/learn_visuals.go:222-520

  - name: File Format Preview Cards
    description: |
      Styled cards showing actual LEF/DEF/Verilog/Liberty syntax examples
    file: module6-eda/pkg/gui/tabs/learn_visuals.go:790-833
...
FilesGenerated:
  - path: cells/fecim_bitcell/fecim_bitcell.lef
    ...
    file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:293
  ...
  - path: cells/fecim_bitcell/fecim_bitcell.lib
    ...
    file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:294
...
IntegrationPoints:
  ...
  - name: Export Package Integration
    ...
    file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:537-554
...
ExternalDependencies:
  - name: OpenLane Docker
    ...
    file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:209-210

  - name: SKY130A PDK
    optional: true
    purpose: Placement validation
    detection: manager.IsPDKInstalled()
    file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:225-229

  - name: Yosys
    optional: false (for validation)
    purpose: Verilog syntax checking
    file: module6-eda/pkg/gui/tabs/builder_validation_tab.go:379
