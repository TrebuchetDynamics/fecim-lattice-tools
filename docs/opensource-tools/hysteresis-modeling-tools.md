...
Demo: Run this project (module1-hysteresis)
  ↓
Explain: Read hysteresis.physics.md
  ↓
...
- **[hysteresis.physics.md](hysteresis.physics.md)** - Physics fundamentals & equations
- **[hysteresis.ELI5.md](hysteresis.ELI5.md)** - Beginner-friendly explanations
- **[hysteresis.demo.md](hysteresis.demo.md)** - Using this project's visualization
- **[hysteresis.research.md](hysteresis.research.md)** - Complete research meta-study
...
|------|----------|-----------|
| **See hysteresis loops in real-time** | This project | hysteresis.demo.md |
| **Understand Preisach theory** | python-preisach + tutorial | hysteresis.physics.md |
...
| **Train ML with noise** | AIHWKIT | crossbar.opensource.md |
...
| **Array-level** | CrossSim + NeuroSim | See crossbar.opensource.md |
