...
- `docs/research/internal-analysis/` moved to the private archive; removed from the public candidate and remains included in the history rewrite list.
- `docs/research/transcripts/COSM_2025_AI_Hardware_Breakthrough/` removed as transcript/slide material with restricted access-restricted risk.
- `docs/research/transcripts/ironlattice-youtube-script.md` removed as audience-specific outreach material.
- `docs/research/tour-group-ironlattice-research.md` removed as research planning material.
- `docs/research/superlattice-material-analysis.md` removed as speculative proprietary-material analysis.
