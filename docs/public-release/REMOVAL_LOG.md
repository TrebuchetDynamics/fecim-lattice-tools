...
- `docs/archive/` was removed from the public candidate tree and remains a history rewrite target.
- `docs/4-research/internal-analysis/` was removed from the public candidate tree and remains a history rewrite target.
- `docs/4-research/transcripts/COSM_2025_AI_Hardware_Breakthrough/` was removed as transcript and slide material with restricted access/restricted risk.
