...
2. **Read PHYSICS.md** for equations
...
- **This project's PHYSICS.md:** `/module1-hysteresis/PHYSICS.md`
- **This project's ELI5:** `/module1-hysteresis/ELI5.module1.md`
...
*This document is part of the FeCIM Visualizer project. For the research meta-study, see `hysteresis.research.md`. For beginner explanations, see `hysteresis.ELI5.md`.*
