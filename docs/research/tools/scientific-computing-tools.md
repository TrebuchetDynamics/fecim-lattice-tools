...
- `docs/modules/hysteresis/physics.md` - Preisach model details
- `docs/modules/crossbar/physics.md` - Array physics
- `docs/research/honesty-audit.md` - FeCIM parameter verification policy
